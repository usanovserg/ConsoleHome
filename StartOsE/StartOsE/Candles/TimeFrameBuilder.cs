...
namespace StartOsE.Candles
{
    ...
    public class TimeFrameBuilder
    {
        ...
        public TimeFrameBuilder(StartProgram startProgram = StartProgram.IsOsTrader)
        {
            _startProgram = startProgram;
            CandleSeriesRealization = CandleFactory.CreateCandleSeriesRealization("Simple");
        ...
        public CandleSeries.CandleMarketDataType CandleMarketDataType
        {
        ...
        private CandleSeries.CandleMarketDataType _candleCreateType;
