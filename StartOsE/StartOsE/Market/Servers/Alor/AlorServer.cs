...
using StartOsE.Market.Servers.Alor.Json;
using StartOsE.Market.Servers.Entity;
using RestSharp;
using System;
...
namespace StartOsE.Market.Servers.Alor
{
    ...
    public class AlorServerRealization : IServerRealization
    {
        ...
        private bool GetCurSessionToken()
        {
            try
            {
                ...
                RestResponse response = client.Execute(requestRest);
        ...
        { 
            ...
            while (startTime < endTime)
            {
                ...
                List<Candle> newCandles = ConvertToStartOsECandles(history);
        ...
        private List<Candle> ConvertToStartOsECandles(CandlesHistoryAlor candles)
        {
        ...
        public List<Trade> GetTickDataToSecurity(Security security, DateTime startTime, DateTime endTime, DateTime actualTime)
        {
            ...
            while (startTime < endTime)
            {
                ...
                List<Trade> newTrades = ConvertToStartOsETrades(history);
        ...
        private List<Trade> ConvertToStartOsETrades(TradesHistoryAlor trades)
        {
        ...
        private void UpDateMyOrder(string data, string portfolioName)
        {
            ...
            Order order = ConvertToStartOsEOrder(baseMessage, portfolioName);
        ...
        private Order ConvertToStartOsEOrder(OrderAlor baseMessage, string portfolioName)
        {
            ...
            try
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    else
                    {
                        ...
                        List<Order> StartOsEOrders = new List<Order>();

                        for(int i = 0;i < orders.Count;i++)
                        {
                            Order newOrd = ConvertToStartOsEOrder(orders[i], portfolio);
                            ...
                            StartOsEOrders.Add(newOrd);
                        }

                        return StartOsEOrders;
            ...
            try
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    else
                    {
                        ...
                        List<MyTrade> StartOsEOrders = new List<MyTrade>();
