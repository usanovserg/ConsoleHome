...
using StartOsE.Market.Servers.Binance.Spot.BinanceSpotEntity;
...
using WebSocket4Net;
using TradeResponse = StartOsE.Market.Servers.Binance.Spot.BinanceSpotEntity.TradeResponse;

namespace StartOsE.Market.Servers.Binance.Spot
{
