...
namespace StartOsE.Market.Servers
{
    ...
    public partial class AServerParameterUi
    {
        ...
        private void ButtonConnect_Click(object sender, RoutedEventArgs e)
        {
            //RobotUiLight1();
            _server.StartServer();
            //BotTabsPainter btp = new BotTabsPainter();
            //btp.UpdaterThreadArea();
        }

        public void  RobotUiLight1()
        { 
            ...
            _strategyKeeper.CreateGlobalPositionController(null, null);
            // _strategyKeeper.CreateBuyAtStopPosViewer(HostStopLimitPoses);

          

            _painter = new BotTabsPainter(_strategyKeeper, null);
