...
using StartOsE.Candles.Factory;
using StartOsE.Candles.Series;
using StartOsE.Market;
using StartOsE.Market.Connectors;

namespace StartOsE.Market.Connectors
{
    public partial class MassSourcesCreateUi : Window
    {
        ...
        private void ActivateGui()
        {
            ...
            ComboBoxCandleMarketDataType.Items.Add(CandleSeries.CandleMarketDataType.Tick);
            ComboBoxCandleMarketDataType.Items.Add(CandleSeries.CandleMarketDataType.MarketDepth);
        ...
        private MassSourcesCreator GetCurSettings()
        {
            ...
            CandleSeries.CandleMarketDataType createType;
        ...
        private void LoadTimeFrameBox(DataGridViewComboBoxCell box)
        {
            ...
            if (SourcesCreator.StartProgram == StartProgram.IsTester)
            {
                ...
                //    ComboBoxCandleMarketDataType.SelectedItem = CandleSeries.CandleMarketDataType.Tick;
                ...
                //    ComboBoxCandleCreateMethodType.SelectedItem = CandleSeries.CandleCreateMethodType.Simple;
