...
namespace StartOsE.Language
{
    public class TraderLocal
    {
        ...
        public string Label302 => OsLocalization.ConvertToLocString(
         "Eng:There are several ways to create robots in StartOsE. Inside the library and as scripts_" +
         "Ru:В StartOsE существует несколько способов создания роботов. Внутри библиотеки и в виде скриптов_");
