...
namespace StartOsE.Language
{
    public class AlertsLocal
    {
        ...
        public string ContextMenuStrip1 => OsLocalization.ConvertToLocString(
            "Eng:Delete_"+
            "Ru:Удалить_");

        public string ContextMenuStrip2 => OsLocalization.ConvertToLocString(
            "Eng:Edit_"+
            "Ru:Редактировать_");

        public string ContextMenuStrip3 => OsLocalization.ConvertToLocString(
            "Eng:Add chart Alert_"
            +
            "Ru:Добавить Алерт на чарт_");

        public string ContextMenuStrip4 => OsLocalization.ConvertToLocString(
