...
namespace StartOsE.Language
{
    public class EntityLocal
    {
        ...
        public string OrderContextToolStripMenuItem1 => OsLocalization.ConvertToLocString(
            "Eng:Add new Order_" +
            "Ru:Добавить ордер_");

        public string OrderContextToolStripMenuItem2 => OsLocalization.ConvertToLocString(
            "Eng:Delete Order_" +
            "Ru:Удалить ордер_");

        public string OrderContextToolStripMenuItem3 => OsLocalization.ConvertToLocString(
            "Eng:Add open trade_" +
            "Ru:Добавить сделку на открытие_");

        public string OrderContextToolStripMenuItem4 => OsLocalization.ConvertToLocString(
             "Eng:Add close trade_" +
             "Ru:Добавить сделку на закрытие_");

        public string OrderContextToolStripMenuItem5 => OsLocalization.ConvertToLocString(
             "Eng:Delete trade_" +
             "Ru:Удалить сделку_");
