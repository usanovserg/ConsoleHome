...
namespace StartOsE.Language
{
    public class ChartsLocal
    {
        ...
        public string ChartToolStripMenuItem1 => OsLocalization.ConvertToLocString(
            "Eng:Drawing a chart_" +
            "Ru:Отрисовка чарта_");

        public string ChartToolStripMenuItem2 => OsLocalization.ConvertToLocString(
            "Eng:Color scheme_" +
            "Ru:Цветовая схема_");

        public string ChartToolStripMenuItem3 => OsLocalization.ConvertToLocString(
            "Eng:Dark_" +
            "Ru:Тёмная_");

        public string ChartToolStripMenuItem4 => OsLocalization.ConvertToLocString(
            "Eng:White_" +
            "Ru:Светлая_");

        public string ChartToolStripMenuItem5 => OsLocalization.ConvertToLocString(
            "Eng:Deal figure_" +
            "Ru:Фигура сделки_");

        public string ChartToolStripMenuItem6 => OsLocalization.ConvertToLocString(
            "Eng:Cross_" +
            "Ru:Перекрестие_");

        public string ChartToolStripMenuItem7 => OsLocalization.ConvertToLocString(
            "Eng:Rhomb_" +
            "Ru:Ромб_");

        public string ChartToolStripMenuItem8 => OsLocalization.ConvertToLocString(
            "Eng:Point_" +
            "Ru:Точка_");

        public string ChartToolStripMenuItem9 => OsLocalization.ConvertToLocString(
            "Eng:Triangle (dont use in debug regime)_" +
            "Ru:Треугольник (тормозит при дебаггинге)_");

        public string ChartToolStripMenuItem10 => OsLocalization.ConvertToLocString(
            "Eng:Hide areas_" +
            "Ru:Скрыть области_");


        public string ChartToolStripMenuItem11 => OsLocalization.ConvertToLocString(
            "Eng:Show areas_" +
            "Ru:Показать области_");

        public string ChartToolStripMenuItem12 => OsLocalization.ConvertToLocString(
            "Eng:StartStop indicator_" +
            "Ru:Редактировать индикатор_");

        public string ChartToolStripMenuItem13 => OsLocalization.ConvertToLocString(
            "Eng:Delete indicator_" +
            "Ru:Удалить индикатор_");

        public string ChartToolStripMenuItem14 => OsLocalization.ConvertToLocString(
            "Eng:Create indicator_" +
            "Ru:Добавить индикатор_");
