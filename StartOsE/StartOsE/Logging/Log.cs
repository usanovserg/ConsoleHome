...
using StartOsE.OsTrader;
using StartOsE.OsTrader.Panels;
using StartOsE.Entity;
using StartOsE.Language;
using StartOsE.Market;
using StartOsE.Market.Servers;
using StartOsE.Market.Servers.Finam;
...
namespace StartOsE.Logging
{
    ...
    public class Log
    {
        ...
        items.Add(new ToolStripMenuItem(OsLocalization.Logging.Label27));
                ...
                ContextMenuStrip menu = new ContextMenuStrip(items as IContainer ?? null);
        ...
        private void Log_ShowFile_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string path = Application.ExecutablePath.Replace("StartOsE.exe", "")
        ...
        /// </summary>
        public void Listen(AServer panel)
        {
        ...
        private static void SetNewErrorMessage(LogMessage message)
        {
            ...
            if (_gridErrorLog.Rows.Count == 500)
            {
                ...
                row1.Cells[0].Value = DateTime.Now.ToString(CurCulture);
            ...
            DataGridViewRow row = new DataGridViewRow();
            row.Cells.Add(new DataGridViewTextBoxCell());
            row.Cells[0].Value = DateTime.Now.ToString(CurCulture);
        ...
        public void Listen(FinamServer panel)
        {
           
        }

        public void Listen(BotPanel server)
        {
