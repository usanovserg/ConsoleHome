    ...
    || nRow.Cells[2].Value.ToString() != position.TimeClose.ToString(_currentCulture))// == false) //AVP убрал потому что во вкладке все позиции, дату позиции не обновляло
        ...
        private void _gridClosePoses_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
                items[0] = new ToolStripMenuItem { Text = OsLocalization.Journal.PositionToolStripMenuItem7 };
        ...
        private void _gridAllPositions_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
                items[1] = new ToolStripMenuItem { Text = OsLocalization.Journal.PositionToolStripMenuItem3 };
                items[1].Click += PositionCloseForNumber_Click;

                // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
                items[2] = new ToolStripMenuItem { Text = OsLocalization.Journal.PositionToolStripMenuItem5 };
                items[2].Click += PositionNewStop_Click;

                // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
                items[3] = new ToolStripMenuItem { Text = OsLocalization.Journal.PositionToolStripMenuItem6 };
                items[3].Click += PositionNewProfit_Click;

                // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
                items[4] = new ToolStripMenuItem { Text = OsLocalization.Journal.PositionToolStripMenuItem7 };
