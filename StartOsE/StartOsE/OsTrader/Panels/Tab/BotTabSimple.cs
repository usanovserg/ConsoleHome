...
using StartOsE.OsTrader.Panels.Tab;
...
using StartOsE.Market.Connectors;
using StartOsE.OsTrader.Panels.Tab.Internal;
    ...
    public class BotTabSimple : IIBotTab
    {
        ...
        public BotTabSimple(string name, StartProgram startProgram)
        {
            ...
            try
            {
                ...
                //if (startProgram != this.StartProgram.IsOsOptimizer)
                //{
                ...
                //if (startProgram == this.StartProgram.IsOsTrader)
                //{
        ...
        /// <summary>
        /// Profit the context menu for setting the chart and indicators
        /// </summary>
//        public // TODO ContextMenuStrip больше не поддерживается. Взамен используйте ContextMenuStripStrip. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
//System.Windows.Forms.ContextMenuStrip GetContextDialog()
//        {
//            return _chartMaster.GetContextMenuStrip();
//        }
        ...
        //        if (StartProgram != this.StartProgram.IsOsTrader || orderCount <= 1)
        //        {
        //            if (position.Direction == Side.Sell)
        //            {
        ...
        private void TryReloadStop(Position position, decimal priceActivate, decimal priceOrder)
        {
            try
            {
                ...
                //if (StartProgram == this.StartProgram.IsOsOptimizer ||
                //    StartProgram == this.StartProgram.IsTester)
                //{
        ...
        private void _connector_TickChangeEvent(List<Trade> trades)
        {
            ...
            //else if (StartProgram == this.StartProgram.IsTester)
            //{
