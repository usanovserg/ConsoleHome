...
namespace StartOsE.Entity
{
    public partial class PositionUi
    {
        ...
        private void CloseOrdersGrid_Click(object sender, EventArgs e)
        {
            ...
            //    // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
            //    items.Add(new ToolStripMenuItem { Text = OsLocalization.Entity.OrderContextToolStripMenuItem1 });
            //    items[0].Click += CloseOrdersAddOrder_Click;

            //    // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
            //    items.Add(new ToolStripMenuItem { Text = OsLocalization.Entity.OrderContextToolStripMenuItem2 });
            ...
            //    ContextMenuStrip menu = new ContextMenuStrip(items.ToArray());
        ...
        private void _tradesGrid_Click(object sender, EventArgs e)
        {
            ...
            //        // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
            //        items.Add(new ToolStripMenuItem(OsLocalization.Entity.OrderContextToolStripMenuItem3,
            ...
            //        // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
            //        items.Add(new ToolStripMenuItem(OsLocalization.Entity.OrderContextToolStripMenuItem4,
            //            itemsOrdersClose.ToArray()));
            //    }

            //    // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
            //    items.Add(new ToolStripMenuItem { Text = OsLocalization.Entity.OrderContextToolStripMenuItem5 });
        ...
        {
            // TODO ToolStripMenuItem больше не поддерживается. Взамен используйте ToolStripToolStripMenuItem. Подробности см. в https://docs.microsoft.com/en-us/dotnet/core/compatibility/winforms#removed-controls
            string str = ((ToolStripMenuItem)sender).Name.ToString().Split(' ')[1];
        ...
        private void SavePosition()
        {
            ...
            Side positionDirection = position.Direction;
            Enum.TryParse(nRow.Cells[5].Value.ToString(), out positionDirection);
